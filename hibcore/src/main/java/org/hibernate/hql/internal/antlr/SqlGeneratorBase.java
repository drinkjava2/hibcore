			...
			case CONSTRUCTOR:
			{
				...
				do {
					...
					if ((_tokenSet_0.member(_t.getType()))) {
						...
						if ( _cnt532>=1 ) { break _loop532; } else {throw new NoViableAltException(_t);}
					}
			...
			case CASE:
			{
				...
				do {
					...
					if ((_t.getType()==WHEN)) {
						...
						if ( _cnt627>=1 ) { break _loop627; } else {throw new NoViableAltException(_t);}
					}
			...
			case CASE2:
			{
				...
				do {
					...
					if ((_t.getType()==WHEN)) {
						...
						if ( _cnt633>=1 ) { break _loop633; } else {throw new NoViableAltException(_t);}
					}
